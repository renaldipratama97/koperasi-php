...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="container">
                <form action="<?= base_url('admin/dokumen/update_dokumen') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="anggota" id="anggota" class="form-control" value="<?php echo $kode_anggota; ?>" readonly>
                    </div>
                    <div class="form-group">
